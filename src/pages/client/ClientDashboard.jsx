...
const ClientDashboard = () => {
  const { client, loading: authLoading } = useUnifiedAuth();
  ...
  useEffect(() => {
    if (!authLoading) {
      fetchData();
      // attendre que l'auth soit chargée avant de fetcher les données
    }
  }, [authLoading]);

  // Et afficher le loader pendant que l'auth charge
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Suivre mes commandes</p>
              </div>
            </div>
          </Link>
