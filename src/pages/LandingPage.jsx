        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Découvrez les avantages de notre pressing
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 bg-linear-to-br ${feature.gradient} rounded-full flex items-center justify-center text-white mb-6 mx-auto`}
                >
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2"
              >
                <div className={`h-2 bg-linear-to-r ${service.gradient}`}></div>
                <div className="p-8">
                  <div
                    className={`w-20 h-20 bg-linear-to-br ${service.gradient} rounded-full flex items-center justify-center text-white mb-6 mx-auto`}
                  >
                    {service.icon}
                  </div>
